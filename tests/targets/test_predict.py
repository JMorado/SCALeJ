...
class TestPredictEnergiesForces:
    ...
    def test_mask_indices_no_cutoff(self, predict_dataset, predict_ff, predict_systems):
    ...
    def test_relative_energies_mean(self, predict_dataset, predict_ff, predict_systems):
    ...
    def test_relative_energies_none(self, predict_dataset, predict_ff, predict_systems):
        e_ref, e_pred, *_ = predict_energies_forces(
            predict_dataset, predict_ff, predict_systems, reference="none"
        )
    ...
    def test_energy_cutoff_filters(self, predict_dataset, predict_ff, predict_systems):
